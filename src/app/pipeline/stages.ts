...
export const pipelineStepLabels: Record<PipelineStep['id'], string> = {
  ...
  comparison: 'Check Existing Questions',
...
export const pipelineStepDescriptions: Record<PipelineStep['id'], string> = {
  ...
  comparison: 'We compare against existing betting questions so we do not publish the same outcome twice.',
...
export const pipelineAgentLabels: Record<PipelineStep['id'], string> = {
  ...
  comparison: 'Question Overlap Checker',
...
export const canonicalStageOrder: PipelineStep[] = [
  ...
  createPipelineStep('comparison', 'Check Existing Questions', 'Question Overlap Checker', 'Compare against existing betting questions with the same outcome.', 'Waiting for official source check.', 'No question overlap check completed yet.', 'market-comparison'),
  createPipelineStep('market-creator', 'Write Market', 'Market Writer', 'Write one clear YES/NO market with rules, evidence, and a deadline.', 'Waiting for question overlap check.', 'No market draft yet.', 'market-drafting'),
